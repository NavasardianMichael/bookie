...
async function main() {
  ...
  const consumerDefs = [
    { name: 'Alex Consumer', phone: BigInt(77000201) },
    { name: 'Maria Patient', phone: BigInt(77000202) },
    { name: 'Sam Bookings', phone: BigInt(77000203) },
    { name: 'Elena Client', phone: BigInt(77000204) },
  ]
